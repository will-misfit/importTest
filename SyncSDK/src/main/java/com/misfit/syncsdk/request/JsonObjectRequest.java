...
public abstract class JsonObjectRequest<T> extends JsonRequest<T> {
    ...
    private static final String TAG = "Request_JsonObjectRequest";
    ...
    public JsonObjectRequest(JSONObject jsonRequest,
        ...
        super(jsonRequest == null ? Method.GET : Method.POST,  /* method */
              PrometheusApi.getInstance().buildUrl(urlPhrase, parametersForGet),  /* url */
        ...
        callId = String.valueOf(PrometheusUtils.createUniqueCallId());
    ...
    protected Response<T> parseNetworkResponse(NetworkResponse response) {
        try {
            ...
            if (CheckUtils.isStringEmpty(jsonString)) {
                Object result = PrometheusUtils.gson.fromJson(jsonString, super.getClass());
                metaMessage = ((PrometheusJsonObjectRequest) result).metaMessage;
                buildResult(result);
            }
    ...
    public Map<String, String> getHeaders() throws AuthFailureError {
        ...
        items.put("api_key", PrometheusConfig.apiKey);
        items.put("locale", PrometheusConfig.language);
