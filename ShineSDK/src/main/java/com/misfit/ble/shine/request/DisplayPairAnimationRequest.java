...
public class DisplayPairAnimationRequest extends Request {
	
	@Override
	public String getRequestName() {
		return "displayPairAnimation";
	}
	...
	public byte getFunctionId() {
		return Constants.DEVICE_CONFIG_DIAGNOSTIC_FUNCTIONS_DISPLAY_PAIR_ANIMATION;
	}
