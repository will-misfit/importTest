...
public class SerialNumberUnlockRequest extends Request {
	
	@Override
	public String getRequestName() {
		return "serialNumberUnlock";
	}
	...
	public void buildRequest() {		
		...
		byte subOperationId = Constants.SERIAL_NUMBER_EXTENDED_OPERATION_ID_UNLOCK;
