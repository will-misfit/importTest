...
public class DisplaySyncAnimationRequest extends Request {
	
	@Override
	public String getRequestName() {
		return "displaySyncAnimation";
	}
	...
	public byte getFunctionId() {
		return Constants.DEVICE_CONFIG_DIAGNOSTIC_FUNCTIONS_DISPLAY_SYNC_ANIMATION;
	}
