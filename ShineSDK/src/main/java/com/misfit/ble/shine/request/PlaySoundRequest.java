...
public class PlaySoundRequest extends Request {
	...
	public byte getSettingId() {
		return Constants.DEVICE_CONFIG_DIAGNOSTIC_FUNCTIONS_PLAY_SOUND;
	}

	public void buildRequest(PlutoSequence.Sound soundSequence, short numOfRepeats, int millisBetweenRepeats) {
		...
		byteBuffer.put(3, Convertor.unsignedByteFromShort(mSoundSequence.getValue()));
	...
	public JSONObject getRequestDescriptionJSON() {
		...
		try {
			json.put("soundSequenceID", mSoundSequence.getValue());
